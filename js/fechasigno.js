...
function validaFechaMenor(campo){
            ...
            var newContent = document.createTextNode("SIGNO GEMINIS \n      NUMERO : 6");
              ...
              var newContent = document.createTextNode("SIGNO CANCER \n      NUMERO : 4");
                ...
                var newContent = document.createTextNode("SIGNO LEO \n      NUMERO : 21");
                  ...
                  var newContent = document.createTextNode("SIGNO VIRGO         NUMERO 10");
        ...
        newDiv.appendChild(newContent); //añade texto al div creado.
         ...
         document.body.insertBefore(newDiv, currentDiv);
		  if((nDia>20) && (nMes==3) || (nDia <=20) && (nMes==4))
        newDiv.style="border: 3px solid #999999; background-color:GREEN; width: 150px ;height:200px ";
        else if ((nDia>20) && (nMes==4) || (nDia <=20) && (nMes==5))
          newDiv.style="border: 3px solid #999999; background-color:BROWN;width: 150px ;height:200px  ";
          else if ((nDia>20) && (nMes==5) || (nDia <=20) && (nMes==6))
            newDiv.style="border: 3px solid #999999; background-color:BLUE; width: 150px ;height:200px ";
            else if ((nDia>20) && (nMes==6) || (nDia <=22) && (nMes==7))
              newDiv.style="border: 3px solid #999999; background-color:YELLOW; width: 150px ;height:200px  ";
              else if ((nDia>22) && (nMes==7) || (nDia <=23) && (nMes==8))
                newDiv.style="border: 3px solid #999999; background-color:ORANGE; width: 150px ;height:200px ";
                else if ((nDia>23) && (nMes==8) || (nDia <=22) && (nMes==9))
                  newDiv.style="border: 3px solid #999999; background-color:lightgreen;width: 150px ;height:200px  ";
                  else if ((nDia>22) && (nMes==9) || (nDia <=22) && (nMes==10))
                    newDiv.style="border: 3px solid #999999; background-color:LIGHTYELLOW; width: 150px ;height:200px ";
                    else if ((nDia>22) && (nMes==10) || (nDia <=22) && (nMes==11))
                     newDiv.style="border: 3px solid #999999; background-color:#705923; width: 150px ;height:200px  ";
                      else if ((nDia>22) && (nMes==11) || (nDia <=21) && (nMes==12))
                        newDiv.style="border: 3px solid #999999; background-color:#AC0180; width: 150px ;height:200px  ";
                        else if ((nDia>21) && (nMes==12) || (nDia <=21) && (nMes==1))
                          newDiv.style="border: 3px solid #999999; background-color:#703FB2; width: 150px ;height:200px  ";
                          else if ((nDia>21) && (nMes==1) || (nDia <=21) && (nMes==2))
                            newDiv.style="border: 3px solid #999999; background-color:#0713AF; width: 150px ;height:200px  ";
                            else if ((nDia>22) && (nMes==21) || (nDia <=23) && (nMes==3))
                              newDiv.style="border: 3px solid #999999; background-color:#8BF3EC; width: 150px ;height:200px  ";
}
